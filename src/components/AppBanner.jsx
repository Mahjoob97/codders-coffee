            ...
            <div>
                <div className='space-y-6 max-w-xl mx-auto '>
                    ...
                    transition={{
                        ...
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos ipsam quae ea! Officiis {''}
                    </motion.p>
                    {/* images link */}
                    <div className='flex justify-center items-center gap-4'>
                        <a href="#" className='max-w-[150px] sm:max-w-[120px] md:max-w-[200px]'>
                            ...
                            transition={{
                                ...
                                damping: 10,
                                delay: 0.4
                            }} src={appStore} alt="appStore logo" />
                        </a>
                        <a href="#" className='max-w-[150px] sm:max-w-[120px] md:max-w-[200px]'>
                            <motion.img initial={{opacity: 0, y: 100}} whileInView={{opacity: 1, y: 0}}
                            transition={{
                                ...
                                damping: 10,
                                delay: 0.4
                            }} src={playStore} alt="appStore logo" />
                        </a>
                    </div>
                </div>
            </div>
